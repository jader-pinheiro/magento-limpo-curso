...
namespace Zemez\SocialLogin\Model;
...
class OAuthToken extends AbstractModel
{
     ...
     *
     * @param DateTimeFactory       $dateCollectionFactory
    ...
    public function __construct(
        DateTimeFactory $dateCollectionFactory,
        Context $context,
        Registry $registry,
        ...
        $this->_dateFactory = $dateCollectionFactory;
        parent::__construct(
            $context,
            $registry,
            $resource,
    ...
    {
        $this->_init('Zemez\SocialLogin\Model\ResourceModel\OAuthToken');
    }
