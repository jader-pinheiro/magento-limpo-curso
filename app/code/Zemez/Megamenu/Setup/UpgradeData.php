<?php
namespace Zemez\Megamenu\Setup;
...
use Zemez\Megamenu\Helper\Data;
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if ($context->getVersion()
            ...
            $attribute  = [
                ...
                'group'         =>  $group,
                'sort_order'    =>  130,
                'frontend'      => 'Zemez\Megamenu\Model\Attribute\Frontend\Configurator',
                'backend'       => 'Zemez\Megamenu\Model\Attribute\Backend\Configurator',
            ];
        ...
        if ($context->getVersion()
            ...
            $attribute  = [
                ...
                'label' => 'View Mode',
                'input' => 'select',
                'source' => 'Zemez\Megamenu\Model\Category\Attribute\Source\ViewMode',
                'required' => false,
                'sort_order' => 160,
                'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                'group' => $group,
