...
namespace Zemez\Parallax\Model;


use Zemez\Parallax\Model\ResourceModel\Block as BlockResourceModel;
use Zemez\Parallax\Model\ResourceModel\Block\Item\CollectionFactory as BlockItemCollectionFactory;
use Zemez\Parallax\Api\Data\BlockItemInterfaceFactory;
use Zemez\Parallax\Api\Data\BlockItemSearchResultsInterfaceFactory;
use Zemez\Parallax\Model\ResourceModel\Block\Item as BlockItemResource;
use Zemez\Parallax\Api\Data\BlockItemInterface;
use Zemez\Parallax\Api\BlockItemRepositoryInterface;
use Zemez\Parallax\Model\Block\ItemFactory as BlockItemFactory;
...
class BlockItemRepository implements BlockItemRepositoryInterface
{
     ...
     * @return \Zemez\Parallax\Model\ResourceModel\Block\Item\Collection
     */
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        ...
        foreach ($collection as $blockModel) {
            ...
            $this->_dataObjectHelper->populateWithArray(
                $blockData,
                $blockModel->getData(),
                'Zemez\Parallax\Api\Data\BlockItemInterface'
            );
