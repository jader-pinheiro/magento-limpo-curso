...
use Zemez\Parallax\Model\ResourceModel\Block\CollectionFactory as BlockCollectionFactory;
use Zemez\Parallax\Api\Data\BlockInterface;
use Zemez\Parallax\Api\Data\BlockInterfaceFactory;
use Zemez\Parallax\Api\Data\BlockSearchResultsInterfaceFactory;
...
class BlockRepository implements BlockRepositoryInterface
{
     ...
     * @return \Zemez\Parallax\Model\ResourceModel\Block\Collection
     */
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        ...
        foreach ($collection as $blockModel) {
            ...
            $this->_dataObjectHelper->populateWithArray(
                $blockData,
                $blockModel->getData(),
                'Zemez\Parallax\Api\Data\BlockInterface'
            );
