...
namespace Zemez\Parallax\Block\Adminhtml\BlockItem\Edit;

use Zemez\Parallax\Helper\Data as ParallaxHelper;
use Zemez\Parallax\Api\Data\BlockItemInterface;
use Zemez\Parallax\Model\Config\Source\Type;
use Zemez\Parallax\Model\Config\Source\VideoFormat;
 ...
 * Block item form.
 *
 * @package Zemez\Parallax\Block\Adminhtml\BlockItem\Edit
 */
class Form extends Generic
{
    ...
    protected function _buildForm()
    {
        ...
        $fieldset->addField('image', 'Zemez\Parallax\Block\Adminhtml\Form\Element\Image', [
            'name' => 'image',
            'label' => __('Image'),
            'title' => __('Image'),
            'required' => true,
        ...
        $fieldset->addField('video_mp4', 'Zemez\Parallax\Block\Adminhtml\Form\Element\Video', [
            'name' => 'video_mp4',
            'label' => __('Video Mp4'),
            'title' => __('Video Mp4'),
        ...
        $fieldset->addField('video_webm', 'Zemez\Parallax\Block\Adminhtml\Form\Element\Video', [
            'name' => 'video_webm',
            'label' => __('Video WebM'),
            'title' => __('Video WebM'),
