...
namespace Zemez\Parallax\Block\Adminhtml\BlockItem;
 ...
 *
 * @package Zemez\Parallax\Block\Adminhtml\BlockItem
 */
class Edit extends Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Zemez_Parallax';
        $this->_controller = 'adminhtml_blockItem';

        if ($this->_isAllowedAction('Zemez_Parallax::item_save')) {
        ...
        if ($this->_isAllowedAction('Zemez_Parallax::item_delete') && $this->_getModel()->getId()) {
            $this->buttonList->add(
                'delete',
                [
                    'label' => __('Delete'),
