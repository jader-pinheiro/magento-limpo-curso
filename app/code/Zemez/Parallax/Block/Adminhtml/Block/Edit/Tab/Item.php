...
namespace Zemez\Parallax\Block\Adminhtml\Block\Edit\Tab;

use Zemez\Parallax\Api\Data\BlockInterface;
use Zemez\Parallax\Model\Config\Source\Type;
use Zemez\Parallax\Model\ResourceModel\Block\Item\CollectionFactory as ItemCollectionFactory;
 ...
 * Block items tab.
 *
 * @package Zemez\Parallax\Block\Adminhtml\Block\Edit\Tab
 */
class Item extends Extended implements TabInterface
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('action', [
            ...
            'type' => 'action',
            'width' => '150px',
            'renderer' => 'Zemez\Parallax\Block\Adminhtml\Block\Edit\Tab\Column\Renderer\Actions',
        ]);
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setTemplate('Zemez_Parallax::widget/grid/massaction_extended.phtml');
