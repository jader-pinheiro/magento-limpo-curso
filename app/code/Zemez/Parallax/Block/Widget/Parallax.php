...
namespace Zemez\Parallax\Block\Widget;

use Zemez\Parallax\Api\BlockRepositoryInterface;
use Zemez\Parallax\Model\Block;
...
class Parallax extends Template implements BlockInterface, IdentityInterface
{
     ...
     * Get parallax block.
     *
     * @return \Zemez\Parallax\Model\Block
     */
    ...
    {
        $this->addChild('configure', 'Zemez\Parallax\Block\Widget\Configure');
