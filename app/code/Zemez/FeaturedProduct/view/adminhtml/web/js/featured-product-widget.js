...
define([
    ...
    'underscore',
    'mage/template',
    'text!Zemez_FeaturedProduct/templates/input-title.html'
], function($, ui, _, mageTemplate, titleTemplate){
    "use strict";

    $.widget('Zemez.featuredProductWidget', {
        ...
        _create: function() {
            ...
            if(typeof($('#select_widget_type').val()) != 'undefined' &&
                $('#select_widget_type').val() != "Zemez\\FeaturedProduct\\Block\\FeaturedProduct\\Widget\\Product") return false;
    ...
    return $.Zemez.featuredProductWidget;
