...
class Delete extends Action
{
    ...
    {
        return $this->_authorization->isAllowed('Zemez_FilmSlider::filmslider_remove');
    }
    ...
    public function execute()
    {
        ...
        if ($id) {
            ...
            try {
                ...
                $sliderRepo = $this->_objectManager->create('Zemez\FilmSlider\Api\SliderRepositoryInterface');
