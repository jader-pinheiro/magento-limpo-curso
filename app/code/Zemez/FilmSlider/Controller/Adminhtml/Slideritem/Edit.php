...
class Edit extends Action
{
    ...
    {
        return $this->_authorization->isAllowed('Zemez_FilmSlider::filmslider_item_edit');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Zemez_FilmSlider::film_slider')
    ...
    public function execute()
    {
        ...
        $sliderItemRepository = $this->_objectManager->create('Zemez\FilmSlider\Api\SliderItemRepositoryInterface');
        ...
        $this->_coreRegistry->register(\Zemez\FilmSlider\Model\SliderItem::REGISTRY_NAME, $model);
        ...
        try {
            ...
            if ($sliderModel && $sliderModel->getData()) {
                $this->_coreRegistry->register(\Zemez\FilmSlider\Model\Slider::REGISTRY_NAME, $sliderModel);
            }
        } catch (\Exception $e) {
