...
class Delete  extends Action
{
    ...
    {
        return $this->_authorization->isAllowed('Zemez_FilmSlider::filmslider_item_delete');
    }
    ...
    public function execute()
    {
        ...
        if ($id) {
            ...
            try {
                ...
                $sliderItemRepo =
                    $this->_objectManager->create('Zemez\FilmSlider\Api\SliderItemRepositoryInterface');
