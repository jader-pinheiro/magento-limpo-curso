...
use Zemez\FilmSlider\Model\ResourceModel\Slider as ResourceSlider;
use Zemez\FilmSlider\Model\ResourceModel\Slider\CollectionFactory as SliderCollectionFactory;
use Zemez\FilmSlider\Api\Data\SliderSearchResultsInterface;
use Zemez\FilmSlider\Api\Data\SliderInterface;
...
class SliderRepository implements SliderRepositoryInterface
{
    ...
    /**
     * @var \Zemez\FilmSlider\Api\Data\SliderInterfaceFactory
     */
     ...
     * @param \Zemez\FilmSlider\Api\Data\SliderInterfaceFactory $dataSliderFactory
    ...
    public function __construct(
        ...
        \Zemez\FilmSlider\Api\Data\SliderInterfaceFactory $dataSliderFactory,
        SliderCollectionFactory $sliderCollectionFactory,
        \Zemez\FilmSlider\Api\Data\SliderSearchResultsInterfaceFactory $searchResultsFactory,
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $criteria)
    {
        ...
        foreach ($collection as $sliderModel) {
            ...
            $this->dataObjectHelper->populateWithArray(
                $sliderData,
                $sliderModel->getData(),
                'Zemez\FilmSlider\Api\Data\SliderInterface'
            );
