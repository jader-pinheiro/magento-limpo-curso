...
namespace Zemez\FilmSlider\Model\ResourceModel\Slider;

use Zemez\FilmSlider\Model\ResourceModel\SliderAbstractCollection;
...
class Collection extends SliderAbstractCollection
{
    ...
    {
        $this->_init('Zemez\FilmSlider\Model\Slider',
            'Zemez\FilmSlider\Model\ResourceModel\Slider');
