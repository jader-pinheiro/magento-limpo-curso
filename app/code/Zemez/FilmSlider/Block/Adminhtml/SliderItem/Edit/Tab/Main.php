 ...
 *
 */
namespace Zemez\FilmSlider\Block\Adminhtml\SliderItem\Edit\Tab;

use Magento\Backend\Block\Widget\Form\Generic;
use Magento\Backend\Block\Widget\Tab\TabInterface;
use Zemez\FilmSlider\Block\Adminhtml\SliderItem\Widget\Element\Image\Canvas;
...
class Main extends Generic implements TabInterface
{
    ...
    public function __construct(
        ...
        \Zemez\FilmSlider\Model\Animation\Source\LayerKlass $layerKlass,
        \Zemez\FilmSlider\Model\Animation\Source\Position $position,
        \Zemez\FilmSlider\Model\Animation\Source\ShowTransition $showTransition,
        \Zemez\FilmSlider\Model\Animation\Source\HideTransition $hideTransition,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        $fieldsetSliderImage->addType('imagecanvas',
            'Zemez\FilmSlider\Block\Adminhtml\SliderItem\Widget\Element\Image\Canvas');
        $fieldsetSliderImage->addField(
            'image_canvas',
            'imagecanvas',
            [
        ...
        $fieldsetSliderImage->addType('layer_sortable_feldset',
            'Zemez\FilmSlider\Block\Adminhtml\SliderItem\Widget\Element\Layer\Sortable');
        ...
        $fieldsetLayerSort->addType('imageinsert',
            'Zemez\FilmSlider\Block\Adminhtml\SliderItem\Widget\Element\Image\Insert');
        ...
        $imageinsert =  $this->getLayout()->createBlock(
            'Zemez\FilmSlider\Block\Adminhtml\SliderItem\Widget\Render\SliderItem\ImageInsert',
        ...
        $imageCanvas =  $this->getLayout()->createBlock(
            'Zemez\FilmSlider\Block\Adminhtml\SliderItem\Widget\Render\SliderItem\Canvas\Image',
            'slideritem.canvas.image.render');

        $imageSortable =  $this->getLayout()->createBlock(
            'Zemez\FilmSlider\Block\Adminhtml\SliderItem\Widget\Render\SliderItem\Layer\Sortable',
