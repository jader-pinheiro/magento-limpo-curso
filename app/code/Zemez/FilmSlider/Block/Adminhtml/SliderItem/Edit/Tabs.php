 ...
 *
 */
namespace Zemez\FilmSlider\Block\Adminhtml\SliderItem\Edit;

use Magento\Framework\DataObject;
use Zemez\FilmSlider\Model\SliderItem;
...
class Tabs extends \Magento\Backend\Block\Widget\Tabs
{
    ...
    /**
     * @var \Zemez\FilmSlider\Api\SliderItemRepositoryInterface
     */
    ...
    public function __construct(\Magento\Backend\Block\Template\Context $context,
                                ...
                                \Zemez\FilmSlider\Api\SliderItemRepositoryInterface $sliderItemRepository,
    ...
    {
        $sliderModel = $this->_coreRegistry->registry(\Zemez\FilmSlider\Model\Slider::REGISTRY_NAME);
        $sliderItemModel = $this->_coreRegistry->registry(\Zemez\FilmSlider\Model\SliderItem::REGISTRY_NAME);
