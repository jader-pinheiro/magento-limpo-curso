...
namespace Zemez\FilmSlider\Block\Adminhtml\SliderItem\Widget\Render\SliderItem;
...
class Image extends Widget implements RendererInterface
{
    ...
    {
        $this->setTemplate('Zemez_FilmSlider::slideritem/widget/render/slideritem/image.phtml');
        parent::_construct();
    }
