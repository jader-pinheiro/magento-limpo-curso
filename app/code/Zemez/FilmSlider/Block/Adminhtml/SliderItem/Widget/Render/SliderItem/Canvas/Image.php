...
namespace Zemez\FilmSlider\Block\Adminhtml\SliderItem\Widget\Render\SliderItem\Canvas;
...
class Image extends Widget implements RendererInterface
{
    ...
    {
        $this->setTemplate('Zemez_FilmSlider::slideritem/widget/render/slideritem/canvas/image.phtml');
        parent::_construct();
    }
