...
namespace Zemez\FilmSlider\Block\Adminhtml\SliderItem\Widget\Render\SliderItem\Layer;
...
class Sortable extends Widget implements RendererInterface
{
    ...
    {
        $this->setTemplate('Zemez_FilmSlider::slideritem/widget/render/slideritem/layer/sortable.phtml');
        parent::_construct();
    }
