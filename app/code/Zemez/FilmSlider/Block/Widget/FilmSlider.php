...
namespace Zemez\FilmSlider\Block\Widget;
...
class FilmSlider extends Template implements \Magento\Widget\Block\BlockInterface
{
    ...
    protected $_template = 'Zemez_FilmSlider::widget/filmslider/default.phtml';

    public function __construct(
        Template\Context $context,
        \Zemez\FilmSlider\Api\SliderRepositoryInterface $filmSliderRepository,
    ...
    public function toHtml()
    {
        ...
        return ($slider->getStatus() && $this->getWidgetStatus()) ? parent::toHtml() : '';
    }
}
