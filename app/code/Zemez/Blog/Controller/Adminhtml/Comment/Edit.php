<?php
namespace Zemez\Blog\Controller\Adminhtml\Comment;
...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Zemez\Blog\Model\CommentFactory $commentFactory
    ...
    {
        return $this->_authorization->isAllowed('Zemez_Blog::comment_save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Zemez_Blog::comment')
